...
/***************************************************************************
 *  exceptions.cpp - Lua related exceptions
 *
...
#else
  : Exception(std::string("Lua runtime error in ") + what + ": " + errmsg)
#endif
{
}
...
#else
  : Exception(std::string("Lua error while running error handler ") + what + ": " + errmsg)
#endif
{
}
